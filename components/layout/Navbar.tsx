        ...
        <div className="flex items-center gap-0.5 mx-auto">
          ...
          <div className="nav-item relative">
            <button className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-sm
              ...
              Services <i className="fa-solid fa-chevron-down text-[10px] transition-transform duration-200" />
            </button>
          ...
          <div className="nav-item relative">
            <button className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-sm
              font-medium text-slate-600 hover:text-[#1641C8] hover:bg-blue-50
              transition-all border-none bg-transparent cursor-pointer font-sans">
              Spécialités <i className="fa-solid fa-chevron-down text-[10px] transition-transform duration-200" />
            </button>
            <div className="nav-dropdown mega">
              <div className="dropdown-title">12 spécialités — Clinique externe</div>
              {SPECIALITES.map((s) => (
          ...
          <>
            ...
            <button
              ...
              className="px-3 py-2 rounded-full border border-slate-200 text-slate-500
                font-semibold text-sm hover:border-red-200 hover:text-red-500 transition-all">
