...
export const MEDECINS: Medecin[] = [
  ...
  { id:3,  nom:'Eliode Pierre',        titre:'Dr',  specialite:'Gynécologie',                   email:'e.pierre@cliniquerebecca.ht',       emoji:'👩‍⚕️', disponibilites:'Lun–Sam 07h–17h', actif:true },
  { id:4,  nom:'Delvalès Doccy',       titre:'Dr',  specialite:'Gynécologie',                   email:'d.doccy@cliniquerebecca.ht',        emoji:'👩‍⚕️', disponibilites:'Lun–Sam 07h–17h', actif:true },
  { id:5,  nom:'Bob-Hallen Treisma',   titre:'Dr',  specialite:'Gynécologie',                   email:'b.treisma@cliniquerebecca.ht',      emoji:'👩‍⚕️', disponibilites:'Lun–Ven 07h–17h', actif:true },
  { id:6,  nom:'Jean Daniel',          titre:'Dr',  specialite:'Gynécologie',                   email:'j.daniel@cliniquerebecca.ht',       emoji:'👩‍⚕️', disponibilites:'Lun–Sam 07h–17h', actif:true },
  { id:7,  nom:'Enold Lubin',          titre:'Dr',  specialite:'Gynécologie',                   email:'e.lubin@cliniquerebecca.ht',        emoji:'👩‍⚕️', disponibilites:'Lun–Sam 07h–17h', actif:true },
  { id:8,  nom:'Dauphin Roolandro',    titre:'Dr',  specialite:'Gynécologie',                   email:'d.roolandro@cliniquerebecca.ht',    emoji:'👩‍⚕️', disponibilites:'Lun–Sam 07h–17h', actif:true },
  ...
  { id:18, nom:'Wisly Joseph',         titre:'Dr',  specialite:'Chirurgie Générale',            email:'w.joseph@cliniquerebecca.ht',       emoji:'⚕️', disponibilites:'Lun–Sam 07h–17h', actif:true },
  { id:19, nom:'Jean Berldine',        titre:'Dr',  specialite:'Chirurgie Générale',            email:'j.berldine@cliniquerebecca.ht',     emoji:'⚕️', disponibilites:'Lun–Ven 07h–17h', actif:true },
  { id:20, nom:'Jeff Tesnor',          titre:'Dr',  specialite:'Chirurgie Générale',            email:'j.tesnor@cliniquerebecca.ht',       emoji:'⚕️', disponibilites:'Lun–Ven 07h–17h', actif:true },
