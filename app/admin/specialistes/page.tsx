...
export default function AdminSpecialistes() {
 ...
 defaultValues: { emoji: '‍', categorie: 'tous', ordre: 0, prix_consultation: 3000, prix_rdv: 3000, type_medecin: 'investisseur' }
 })
 ...
 reset({ emoji: '‍', categorie: 'tous', ordre: 0, prix_consultation: 3000, prix_rdv: 3000, type_medecin: 'investisseur' })
 ...
 emoji: s.emoji || '‍', telephone: s.telephone || '', email: s.email || '',
 ...
 {editData.emoji || '‍'} <span style={{ fontSize: 12, color: '#64748b' }}>Changer</span>
 </button>
 {editEmojiPicker && (
