...
Sinon: liste les interactions par ordre de gravité ( modérée, sévère). Sois concis, max 150 mots.`
 }]
 })
 }).then(r => r.json())
 return data.content?.[0]?.text || ''
...
const DOCUMENTS = [
 ...
 { id: 'observation_infirmiere', label: 'Observation Infirmière', icon: '‍', services: ['clinique','hospit'] },
 ...
 { id: 'ecg', label: 'Compte rendu ECG', icon: '', services: ['clinique'] },
 ...
 { id: 'ordonnance_eclampsie',label: 'Ordonnance Éclampsie', icon: '', services: ['maternite'] },
 { id: 'ordonnance_postop', label: 'Ordonnance Post-Op OBGYN', icon: '', services: ['maternite','sop'] },
 { id: 'consentement', label: 'Consentement Éclairé', icon: '', services: ['clinique','sop','dentiste','physio'] },
