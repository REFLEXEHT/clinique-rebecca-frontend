...
const BRANCHES_CLINIQUE = [
 ...
 { slug:'gynecologie', label:'Gynécologie', icon:'‍', email:'gyneco@cliniquerebecca.ht',
 ...
 { slug:'chirurgie-generale', label:'Chirurgie Générale', icon:'', email:'chirurgie@cliniquerebecca.ht',
...
const MEDECINS_INFO: Record<string,any> = {
 ...
 'Dr Eliode Pierre': { email:'e.pierre@cliniquerebecca.ht', specialite:'Gynécologie', emoji:'‍' },
 'Dr Delvalès Doccy': { email:'d.doccy@cliniquerebecca.ht', specialite:'Gynécologie', emoji:'‍' },
 'Dr Bob-Hallen Treisma': { email:'b.treisma@cliniquerebecca.ht', specialite:'Gynécologie', emoji:'‍' },
 'Dr Jean Daniel': { email:'j.daniel@cliniquerebecca.ht', specialite:'Gynécologie', emoji:'‍' },
 'Dr Enold Lubin': { email:'e.lubin@cliniquerebecca.ht', specialite:'Gynécologie', emoji:'‍' },
 'Dr Dauphin Roolandro': { email:'d.roolandro@cliniquerebecca.ht', specialite:'Gynécologie', emoji:'‍' },
...
function PageCliniqueExterne() {
 ...
 <div style={{width:50,height:50,borderRadius:14,background:'linear-gradient(135deg,#1641C8,#0d9488)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:22,flexShrink:0}}>{info.emoji||'‍'}</div>
 <div style={{flex:1}}>
 ...
 {info.email&&<a href={`mailto:${info.email}`} style={{color:'#94a3b8',fontSize:11,display:'block',marginTop:3,textDecoration:'none'}}> {info.email}</a>}
 </div>
...
const SERVICES_CONTENT: Record<string,{
 ...
 'salle-sop':{
 titre:'Salle Opératoire (SOP)',icon:'',couleur:'#475569',gradient:'linear-gradient(135deg,#0f1e3d,#374151)',
...
function PageService({slug}:{slug:string}) {
 ...
 <a href={`mailto:${cfg.medecin.email}`} style={{color:'#94a3b8',fontSize:11,display:'block',marginTop:3,textDecoration:'none'}}> {cfg.medecin.email}</a>
