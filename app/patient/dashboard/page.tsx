...
export default function PatientDashboard() {
 ...
 Prenez vos médicaments selon les instructions de votre médecin. Ne les arrêtez pas sans avis médical.
 </div>
 </div>
 )
 })}
 ...
 Ce résultat nécessite une consultation médicale. Contactez votre médecin.
 </div>
 )}
